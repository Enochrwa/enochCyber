...
def test_subscribe_feed():
    # Unsubscribe
    response_unsubscribe = client.post("/api/v1/threat-intelligence/feeds/threatfox/subscribe", json={"is_subscribed": False})
    ...
    response_subscribe = client.post("/api/v1/threat-intelligence/feeds/threatfox/subscribe", json={"is_subscribed": True})
